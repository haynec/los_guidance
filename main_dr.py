...
# Plot the results
plot_ral_mc_results(CT_mc_results, DT_mc_results, nodes, params, True, showlegend=False)
plot_ral_mc_timing_results(CT_mc_results, DT_mc_results, nodes, params, showlegend=False)